...
<head>
  <title>@yield('titulo')</title>    <!-- aqui puxa o nome na aba de cada um  -->
  <meta charset="utf-8">
...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap">
    ...
    @yield('conteudo')  <!-- essa fç é tipo o include do php. é onde vai entrar o conteudo da sua página. O header e o footer é o mesmo em todas as páginas. Posso ter vários yields. 'conteudo' é um nome dado por mim.  -->
